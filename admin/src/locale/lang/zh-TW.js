export default {
  ...
  update: '上傳數據',
  moleculer_manager: 'moleculer管理',
  moleculer_configs: 'moleculer配置',
  swagger_doc: 'swagger 文档',
  swagger_board:'swagger仪表盘',
  moleculer_nodes: '节点管理',
  moleculer_services: 'services服务',
  doc: '文檔',
