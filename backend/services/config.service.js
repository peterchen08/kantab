...
module.exports = {
	...
	mixins: [
		DbService({ 
			createActions: false ,
			cache:{
				eventName:"cache.clean.v1.config"
			}
		}),
		//CacheCleaner(["cache.clean.v1.config"])
	],
	...
	settings: {
		...
		defaultConfig: {
			...
			"admins.defaultRoles": [C.ROLE_GUEST],
			"admins.mobile.enabled": true,
			"admins.password.minimum": 6, // TODO
		},
